...
I chose the BioBike framework as the platform for the system. This
...
When making the decision that decided the basis of the system the only
...
aspects. That is the code for the system is open sourced under the MIT
