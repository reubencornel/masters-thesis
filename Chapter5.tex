...
existence of two types of knowledge namely: declarative knowledge\cite{actr-tut}, is
the type of knowledge that a person is supposed to know when solving a
problem and procedural memory
