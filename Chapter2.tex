...
% re use would help ease of development 
 ...
 From an engineering standpoint a cognitive
  modeller essentially building intelligent agents and in quite a
  number of cases work done by one researcher can be reused elsewhere
  by someone else. No work has been performed on this engineering
  aspect of cognitive architectures and the aim of this project is to
