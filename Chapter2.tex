...
ACT-R was developed by Anderson et. al. \cite{anderson_jr-etal:2004a}
at Carnegie Mellon University to validate results performed by in the
area of cognitive psychology. ACT-R's origins lie in an attempt by
...
eventually grew into ACT\cite{Anderson76} which in due course evolved
into ACT-R\cite{Anderson83}.
...
\ref{ARTR_ARCH}. I describe each of these modules below.
